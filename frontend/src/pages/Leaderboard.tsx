...
import { Trophy, Users, RefreshCw, Search, ChevronLeft } from 'lucide-react'
    ...
    <div className="space-y-5 animate-in fade-in duration-300">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="h-10 w-10 rounded-full hover:bg-accent grid place-items-center transition-colors shrink-0"
        >
          <ChevronLeft className="h-5 w-5" />
        </button>
        <div className="flex-1">
          <div className="text-xs uppercase tracking-[0.25em] text-muted-foreground font-semibold">Leaderboards</div>
          <h1 className="text-2xl font-bold mt-1">Рейтинг 2026</h1>
        </div>
        <button
        ...
        {data.stats && (
          <div className="p-5 border-b border-border">
            <div className="grid grid-cols-3 gap-2 text-center">
              ...
              <div className="bg-muted/50 rounded-lg py-3">
                <div className="text-2xl font-bold">{data.tournaments?.length || 0}</div>
